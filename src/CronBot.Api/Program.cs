...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CronBot API", Version = "v1" });
...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "CronBot";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "CronBot";
